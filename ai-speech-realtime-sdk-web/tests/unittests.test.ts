...
describe("TestWebSocketClient", () => {
  ...
  it("should parse parameters", () => {
    ...
    expect(mockWebSocket.url).toBe(
      "realtimeEndpoint?isAckEnabled=false&partialSilenceThresholdInMs=0&finalSilenceThresholdInMs=1000&languageCode=en-US&modelDomain=GENERIC&stabilizePartialResults=MEDIUM&shouldIgnoreInvalidCustomizations=false&customizations=%5B%7B%22compartmentId%22%3A%2212345%22%2C%22customizationAlias%22%3A%22test%22%7D%5D"
    );
  });
